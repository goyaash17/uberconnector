...
package org.mule.modules.ubercon.adapters;
...
import org.mule.modules.ubercon.generated.adapters.UberConConnectorCapabilitiesAdapter;
import org.mule.modules.ubercon.generated.adapters.UberConConnectorProcessAdapter;
...
/**
 * A {@code UberConConnectorOAuth2Adapter} is a wrapper around {@link UberConConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-13T02:14:48-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class UberConConnectorOAuth2Adapter
    extends UberConConnectorProcessAdapter
    implements OAuth2Adapter
{
    ...
    private final static Logger LOGGER = Logger.getLogger(UberConConnectorOAuth2Adapter.class);

    public UberConConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
