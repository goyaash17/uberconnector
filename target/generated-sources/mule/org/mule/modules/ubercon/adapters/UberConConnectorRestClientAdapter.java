...
public class UberConConnectorRestClientAdapter
    extends UberConConnectorOAuth2Adapter
    implements MuleContextAware, Disposable, Initialisable
{
    ...
    public UberConConnectorRestClientAdapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
        super(oauthManager);
    }
